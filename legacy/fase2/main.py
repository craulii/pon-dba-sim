...
sys.path.insert(0, os.path.dirname(__file__))                              # dba_basic.py local
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", ".."))    # simulator/, metrics/ (raiz del repo)
...
from dba_basic           import BasicDBA
