...
\texttt{dba\_giant.py}, \texttt{dba\_ipact.py}, \texttt{dba\_qos.py} & Los 3 algoritmos DBA \\
\texttt{traffic.py} & Generadores CBR/Poisson/Pareto \\
\texttt{metrics/collector.py} & Latencia, SLA, throughput, jitter \\
\texttt{main.py}, \texttt{run\_experiments.py} & CLI y orquestación de escenarios \\
\bottomrule
\end{tabular}
\end{table}
